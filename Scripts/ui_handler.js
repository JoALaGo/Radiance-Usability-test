...
function populateParents() {
    ...
    for (let i in this.available_parents) {
        ...
        if (this.available_parents[i][2] == 'array') {
            if_array = '<div class="col-sm-2" style=""><a class="instance_add" style="margin-left:auto;margin-right:auto;" data-toggle="tooltip" data-placement="bottom" title="Add an instance " onclick="createInstanceFromProfileElement(' + "'test'" + ',' + "'available_children'" + ',' + i + ',' + i + ',1)")"><strong>+</strong></a></div>';
...
function showVariableInput(variable_name, dom_target, current_value, is_variable_subset, parent_index, instance_id, is_instance, type, subset_name) {
    ...
    if (!customLayout.custom) {
        ...
        if (hide_variable) {
            ...
            document.getElementById(dom_target).innerHTML += '<div class="col-sm-12"style="font-family: ' + "Roboto" + ';"><div class="row"><div class="col-sm-12"><strong>' + custom_name.split('_').join(' ') + '</strong></div><div class="col-sm-12"><div class="row text-center" style="padding-left:0px;padding-right:0px;margin-left:0px;margin-right:0px;"><div id="' + input_id + '_available_parameters" class="parameter_metadata" style="display:none;">' + JSON.stringify(available_parameters) + '</div>' + custom_html + '</div></div></div><div id="' + custom_name + '_reserved_code" style="display:none;">' + custom_code + '</div>';
            ...
            //we gotta get the custom HTML for the inline shit
            document.getElementById(dom_target).innerHTML += '<div class="col-sm-12"style="font-family: ' + "Roboto" + ';"><div class="row"><div class="col-sm-12">' + custom_name.split('_').join(' ') + '</div></div></div>';
